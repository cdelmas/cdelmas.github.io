...
What do social providers have in common? OAuth2.footnote:[Well, they probably have many more in common.]. Good, it seems that it fulfills our needs, as it is implemented by almost all major identity providers. The problem is: how do we integrate it to your API?
...
For our purpose, the JWT will contain the authorizations as an object:
