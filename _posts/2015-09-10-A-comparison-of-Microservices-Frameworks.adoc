...
HTTPS is configured in the YAML configuration file. The documentation explains exactly how to set it up. Note that you will need to install a self-signed certificate in your store, and it will run. Sadly, the store password is not encrypted.
